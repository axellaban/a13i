...
- `quick-wins-ai.html` (`/quick-wins-ai`) — lead magnet 3, Mapa de Oportunidades de IA (32 iniciativas, 4 verticales × 4 pilares). La página solo califica el lead (vertical, empresa, facturación, WhatsApp) y lo manda a WhatsApp; el PDF con las 32 iniciativas lo manda Axel a mano después. Solo alcanzable por link directo.
